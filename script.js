...
async function getData(location) {
    const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=eebca7c5efe5281f48e5bd936f7fd188&units=imperial`);
    const currentWeatherData = await response.json();
    const response2 = await fetch(`https://api.openweathermap.org/geo/1.0/direct?q=${location}&limit=5&appid=eebca7c5efe5281f48e5bd936f7fd188`);
